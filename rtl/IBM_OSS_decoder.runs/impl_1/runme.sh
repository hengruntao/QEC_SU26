...
HD_PWD='C:/Users/rimpl/vivado/QEC_SU26/rtl/IBM_OSS_decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dmembp_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dmembp_top.tcl -notrace
