...
HD_PWD='C:/Users/rimpl/vivado/QEC_SU26/rtl/IBM_OSS_decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dmembp_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dmembp_top.tcl
